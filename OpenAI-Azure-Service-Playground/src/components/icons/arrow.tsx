// icon:arrow-down-circle | Teeny Icons https://teenyicons.com/ | Anja van Staden
import * as React from 'react'
import { JSX } from 'react/jsx-runtime'

function IconArrowDownCircle(props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            fill='none'
            viewBox='0 0 15 15'
